...
test.cb('geojson endpoint with simple GET should return 1 result', function (t) {
  var key = 'simpleGet';
...
test.cb('geojson endpoint with simple POST should return 1 result', function (t) {
  var key = 'simplePost';
  nock.back('geojson-' + key + '.json', function (nockDone) {
    var search = new Search(payload[key]);
    search.geojson(function (err, response) {
...
test.cb('geojson endpoint with simple POST with limit 2 should return 2 result', function (t) {
...
test.cb('geojson endpoint POST intersects', function (t) {
...
test.cb('geojson endpoint GET intersects with no match', function (t) {
