...
test.cb('count endpoint with simple POST should return 1 result', function (t) {
  var key = 'simplePost';
  nock.back('count-' + key + '.json', function (nockDone) {
    var search = new Search(payload[key]);
    search.count(function (err, response) {
...
test.cb('count endpoint with simple POST should return 2 result', function (t) {
...
test.cb('count endpoint POST intersects', function (t) {
...
test.cb('count endpoint GET intersects with no match', function (t) {
...
test.cb('count endpoint GET with fields', function (t) {
  var key = 'getFields';
  nock.back('count-' + key + '.json', function (nockDone) {
    var search = new Search(payload[key]);
    search.count(function (err, response) {
