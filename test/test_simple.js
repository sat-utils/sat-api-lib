...
test.cb('root endpoint with simple POST should return 1 result', function (t) {
  var key = 'simplePost';
  nock.back('simple-' + key + '.json', function (nockDone) {
    var search = new Search(payload[key]);
    search.simple(function (err, response) {
...
test.cb('root endpoint with simple post limit 2 and fields', function (t) {
...
test.cb('root endpoint with simple POST with limit 2 should return 2 resul', function (t) {
...
test.cb('root endpoint with POST date range', function (t) {
...
test.cb('root endpoint GET intersects with no match', function (t) {
...
test.cb('root endpoint GET invalid intersect', function (t) {
...
test.cb('root endpoint GET string intersects', function (t) {
...
test.cb('root endpoint GET string intersects with satelline_name', function (t) {
